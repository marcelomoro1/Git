...
**ATUALIZAR O REPOSITÓRIO LOCAL EM RELAÇÃO A NUVEM (DO GIT)**
- git pull origin main //traz do remoto até o local

**ERRO DE PUSH QUANDO O LOCAL ESTA DESATUALIZADO DA NUVEM E VOCE TEM COMMITS PARA DAR PUSH**
...
**SOBREESCREVENDO O HISTORICO DA NUVEM PELO LOCAL**
-git push -f
